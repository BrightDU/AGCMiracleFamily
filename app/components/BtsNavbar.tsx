...
import loo from '../public/btslogo3.png'; // bts logo 
      ...
      >
        <div className="container mx-auto flex justify-between items-center px-4 sm:px-6 lg:px-8 h-16">
          ...
          <div className="flex items-center">
              <Link href="/" className="hover:text-[#93e9be] ml-[-30px] w-[100px] mb-[-1px] transition-all duration-300">
                <Image src={loo} alt="Logo" width={140} height={20} className="object-cover" />
              </Link>
            </div>
          ...
          <ul className="hidden md:flex space-x-6  md:mr-[-10px] items-center mx-auto">
            ...
            <div className="flex items-center">
            <Link href="/" className="hover:text-[#93e9be] ml-[65px] transition-all duration-300">
                <Image src={lo} alt="Logo" width={143} height={40} className="object-cover" />
              </Link>
            </div>
          </ul>
